...
public class GraphDrawing implements ActionListener { 
    ...
    JFrame frame;
    JTextField fa, fb, fc; // Text fields where to enter the coefficients.
    ...
    public GraphDrawing() {
        frame = new JFrame("Graph Simulator");
        ...
        JButton drawLine = new JButton("Draw Parabola");
    ...
    public void actionPerformed(ActionEvent ae) { 
        try { // Take in a, b & c from text boxes.
